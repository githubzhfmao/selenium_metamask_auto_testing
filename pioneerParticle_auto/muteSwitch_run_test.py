...
def runMuteSwitchTestnet(addr):
    ...
    def swap(a, b):
        token_x = a
        token_y = b
        driver.find_element(By.XPATH,"//button[text()='Select token']").click()
    ...
    def addLP(a, b):
        ...
        driver.find_element(By.XPATH,"//button[text()='Select token']").click()
        driver.find_element(By.XPATH,"(//p[text()='" + token_x + "'])[last()]").click()
        driver.find_element(By.XPATH,"//button[text()='Select token']").click()
        driver.find_element(By.XPATH,"//p[text()='" + token_y + "']").click()
        time.sleep(3)
        inputs = driver.find_elements_by_xpath('//input')
        ...
        inputs[0].send_keys(value)
        time.sleep(5)
        driver.find_element(By.XPATH,'//button[text()="Supply"]').click()
        auto.signConfirm()
        auto.signConfirm()
        driver.find_element(By.XPATH,"//*[@alt='Close']").click()
    ...
    def farming():
        driver.find_element(By.XPATH,"//a[text()='Farming']").click()
        driver.find_element(By.XPATH,'//*[@id="app"]/main/div/div[3]/div/div/div[1]').click()
        while True:
            try:
                element = driver.find_element(By.XPATH,"//button[text()='Approve']")
            except NoSuchElementException:
                driver.find_element(By.XPATH,'//button[text()="Harvest"]').click()
                time.sleep(3)
                ...
                driver.find_element(By.XPATH,"//button[text()='Approve']").click()
                auto.signConfirm()
                driver.find_element(By.XPATH,'//button[text()="MAX"]').click()
